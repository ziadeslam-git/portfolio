...
export const FloatingTechIcons = ({ layer }: { layer: "back" | "front" }) => {
  ...
  const backIcons = [
    {
      ...
      position: "top-[10%] left-[5%] sm:left-[10%] lg:-left-[5%]",
      delay: 0,
      glowColor: "accent",
      scale: 0.85,
      blur: true
    },
    {
      ...
      position: "top-[15%] right-[5%] sm:right-[10%] lg:-right-[5%]",
      delay: 1.5,
      glowColor: "blue",
      scale: 0.8,
      blur: true
    },
    {
      ...
      position: "bottom-[20%] left-[10%] sm:left-[15%] lg:left-[5%]",
      delay: 1,
      glowColor: "red",
      scale: 0.9,
      blur: true
  ...
  const frontIcons = [
    {
      ...
      position: "top-[40%] left-[0%] sm:left-[5%] lg:-left-[15%]",
      delay: 0.5,
      glowColor: "accent",
      scale: 1.15,
      blur: false
    },
    {
      ...
      position: "top-[40%] right-[0%] sm:right-[5%] lg:-right-[15%]",
      delay: 2,
      glowColor: "accent",
      scale: 1.1,
      blur: false
    },
    {
      ...
      position: "bottom-[20%] right-[5%] sm:right-[15%] lg:right-[5%]",
      delay: 2.5,
      glowColor: "primary",
      scale: 1.05,
      blur: false
  ...
  const iconsToRender = layer === "back" ? backIcons : frontIcons;

  return (
    <div className={`absolute inset-0 pointer-events-none ${layer === "back" ? "z-0" : "z-20"}`}>
